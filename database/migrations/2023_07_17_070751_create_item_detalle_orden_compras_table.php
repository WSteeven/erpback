...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('item_detalle_orden_compras', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('orden_compra_id')->references('id')->on('ordenes_compras')->cascadeOnDelete()->cascadeOnUpdate();
    ...
    {
        Schema::dropIfExists('item_detalle_orden_compras');
    }
};
