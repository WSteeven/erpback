...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('med_estados_solicitudes_examenes', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('solicitud_examen_id');
            $table->foreign('solicitud_examen_id')->references('id')->on('med_solicitudes_examenes')->cascadeOnDelete()->cascadeOnUpdate();
