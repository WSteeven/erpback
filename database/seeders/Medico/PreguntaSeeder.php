...
class PreguntaSeeder extends Seeder
{
    ...
    public function run()
    {
        Pregunta::insert([
            ...
            [
                'codigo' => '14c',
                'pregunta' => 'Para realizar tu trabajo, ¿cómo valoras la información que recibes sobre los siguientes aspectos? La cantidad de trabajo que se espera que hagas',
            ],
            [
                'codigo' => '14d',
