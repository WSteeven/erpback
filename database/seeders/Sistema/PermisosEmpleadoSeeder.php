...
class PermisosEmpleadoSeeder extends Seeder
{
    /**
     * Run the database seeds.
     * php artisan db:seed --class="Database\Seeders\Sistema\PermisosEmpleadoSeeder"
     * @return void
     */
    public function run()
    {
        ...
        foreach ($permisos as $permiso) {
            ...
            $empleado->givePermissionTo($permisoCreado);
        }
    }
}
