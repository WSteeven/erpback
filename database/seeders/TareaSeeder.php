    ...
    public function run()
    {
        Tarea::insert([
            ...
            [
                ...
                'codigo_tarea_cliente' => 'ERH147',
                'fecha_solicitud' => '19/04/2022',
                'titulo' => 'Ventana de trabajo de Cambio de CPE e interfaces a 10G',
            ...
            [
                ...
                'detalle' => 'Asistencia para la revisión de la UM backup del servicio ECECBEE10096683I, se encuentra down y no se recibe potencia en ninguno de los extremos.',
                'observacion' => null,
                'estado' => Subtarea::CREADO,
                'destino' => Tarea::PARA_CLIENTE_FINAL,
                'proyecto_id' => null,
