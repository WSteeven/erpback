...
class PermisosTareasSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::firstOrCreate(['name' => Permisos::ACCEDER . 'alimentacion_grupo'])->syncRoles([$jefeTecnico, $coordinador, $coordinadorBackup]);
        Permission::firstOrCreate(['name' => Permisos::VER . 'alimentacion_grupo'])->syncRoles([$jefeTecnico, $coordinador, $coordinadorBackup]);
        Permission::firstOrCreate(['name' => Permisos::CREAR . 'alimentacion_grupo'])->syncRoles([$jefeTecnico, $coordinador, $coordinadorBackup]);
        Permission::firstOrCreate(['name' => Permisos::EDITAR . 'alimentacion_grupo'])->syncRoles([$jefeTecnico, $coordinador, $coordinadorBackup]);
    }
}
