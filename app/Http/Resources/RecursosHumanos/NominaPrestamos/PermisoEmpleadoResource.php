...
//        $controller_method = $request->route()->getActionMethod();
        return [
            ...
            'empleado_info' => $this->empleadoInfo?->nombres . ' ' . $this->empleadoInfo?->apellidos,
            'departamento' => $this->empleadoInfo?->departamento->nombre,
            'id_jefe_inmediato' => $this->empleadoInfo?->jefe->id,
            'jefe_inmediato' => $this->empleadoInfo?->jefe->nombres . '' . $this->empleadoInfo?->jefe->apellidos,
