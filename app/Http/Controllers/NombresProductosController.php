...
class NombresProductosController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return response()->json(['mensaje' => 'El nombre de producto ha sido creado con exito', 'modelo' => $nombreProducto]);
    }
    ...
    public function update(Request $request, NombreProducto  $nombreProducto)
    {
        ...
        return response()->json(['mensaje' => 'El nombre de producto ha sido actualizado con exito', 'modelo' => $nombreProducto]);
    }

    public function destroy(NombreProducto $nombreProducto)
    {
        $nombreProducto->delete();
        return response()->json(['mensaje' => 'El nombre de producto ha sido eliminado con exito', 'modelo' => $nombreProducto]);
    }
}
