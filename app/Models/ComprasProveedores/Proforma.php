 ...
 * @property-read Collection<int, ItemDetalleProforma> $detalles
 ...
 * @method static Builder|Proforma acceptRequest(?array $request = null)
 * @method static Builder|Proforma filter(?array $request = null)
 * @method static Builder|Proforma ignoreRequest(?array $request = null)
 * @method static Builder|Proforma newModelQuery()
 * @method static Builder|Proforma newQuery()
 * @method static Builder|Proforma query()
 * @method static Builder|Proforma setBlackListDetection(?array $black_list_detections = null)
 * @method static Builder|Proforma setCustomDetection(?array $object_custom_detect = null)
 * @method static Builder|Proforma setLoadInjectedDetection($load_default_detection)
 * @method static Builder|Proforma whereAutorizacionId($value)
 * @method static Builder|Proforma whereAutorizadorId($value)
 * @method static Builder|Proforma whereCausaAnulacion($value)
 * @method static Builder|Proforma whereClienteId($value)
 * @method static Builder|Proforma whereCodigo($value)
 * @method static Builder|Proforma whereCreatedAt($value)
 * @method static Builder|Proforma whereDescripcion($value)
 * @method static Builder|Proforma whereDescuentoGeneral($value)
 * @method static Builder|Proforma whereEstadoId($value)
 * @method static Builder|Proforma whereForma($value)
 * @method static Builder|Proforma whereId($value)
 * @method static Builder|Proforma whereIva($value)
 * @method static Builder|Proforma whereObservacionAut($value)
 * @method static Builder|Proforma whereSolicitanteId($value)
 * @method static Builder|Proforma whereTiempo($value)
 * @method static Builder|Proforma whereUpdatedAt($value)
 * @mixin Eloquent
 */
class Proforma extends Model implements Auditable
{
     ...
     * @throws Throwable
     */
    public static function guardarDetalles(Proforma $proforma, $items)
    {
        try {
            DB::beginTransaction();
