...
class EvaluacionPersonalidadService
{
     ...
     * @return mixed
     */
    public static function verificarExisteEvaluacionPostulacion(int $postulacion_id)
    {
        return EvaluacionPersonalidad::where('postulacion_id', $postulacion_id)->exists();
    }
