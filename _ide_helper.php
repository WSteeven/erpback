...
namespace Illuminate\Support\Facades {
     ...
     */        class Http {
        ...
        {
                        return \Illuminate\Http\Client\Factory::defaultTimeout();
        }
            }
            /**
     * 
...
namespace eloquentFilter\Facade {
     ...
     */        class EloquentFilter {
         ...
         * @throws \ReflectionException
         * @static 
         */        public static function apply($builder, $request = null, $ignore_request = null, $accept_request = null, $detections_injected = null, $black_list_detections = null)
        {
                        /** @var \eloquentFilter\QueryFilter\Core\FilterBuilder\MainQueryFilterBuilder $instance */
                        $instance->apply($builder, $request, $ignore_request, $accept_request, $detections_injected, $black_list_detections);
        }
                    /**
         * 
         *
         * @return string 
         * @static 
         */        public static function getNameBuilder()
        {
                        /** @var \eloquentFilter\QueryFilter\Core\FilterBuilder\MainQueryFilterBuilder $instance */
                        return $instance->getNameBuilder();
        }
                    /**
         * 
         *
         ...
         * @static 
         */        public static function filterRequests($index = null)
        {
                        /** @var \eloquentFilter\QueryFilter\Core\FilterBuilder\MainQueryFilterBuilder $instance */
                        return $instance->filterRequests($index);
        }
                    /**
         * 
         *
         * @return mixed 
         * @static 
         */        public static function getAcceptedRequest()
        {
                        /** @var \eloquentFilter\QueryFilter\Core\FilterBuilder\MainQueryFilterBuilder $instance */
                        return $instance->getAcceptedRequest();
        }
                    /**
         * 
         *
         * @return mixed 
         * @static 
         */        public static function getIgnoredRequest()
        {
                        /** @var \eloquentFilter\QueryFilter\Core\FilterBuilder\MainQueryFilterBuilder $instance */
                        return $instance->getIgnoredRequest();
        }
                    /**
         * 
         *
         * @return mixed 
         * @static 
         */        public static function getRequestEncoded()
        {
                        /** @var \eloquentFilter\QueryFilter\Core\FilterBuilder\MainQueryFilterBuilder $instance */
                        return $instance->getRequestEncoded();
        }
                    /**
         * 
         *
         * @return mixed 
         * @static 
         */        public static function setRequestEncoded($request, $salt)
        {
                        /** @var \eloquentFilter\QueryFilter\Core\FilterBuilder\MainQueryFilterBuilder $instance */
                        return $instance->setRequestEncoded($request, $salt);
        }
                    /**
         * 
         *
         * @return mixed 
         * @static 
         */        public static function getInjectedDetections()
        {
                        /** @var \eloquentFilter\QueryFilter\Core\FilterBuilder\MainQueryFilterBuilder $instance */
                        return $instance->getInjectedDetections();
        }
                    /**
         * 
         *
...
namespace Illuminate\Support {
     ...
     */        class Collection {
         ...
         * 
         *
         * @see \App\Models\FondosRotativos\Saldo\Acreditaciones::setAttribute()
         * @static 
...
namespace Illuminate\Database\Query {
     ...
     */        class Builder {
         ...
         * 
         *
         * @see \eloquentFilter\ServiceProvider::attachFilterToQueryBuilder()
         * @param mixed $request
         * @static 
         */        public static function filter($request = null)
        {
                        return \Illuminate\Database\Query\Builder::filter($request);
        }
                    /**
         * 
         *
         * @see \eloquentFilter\ServiceProvider::attachResponseFilterToQueryBuilder()
         * @param mixed $callback
         * @static 
         */        public static function getResponseFilter($callback = null)
        {
                        return \Illuminate\Database\Query\Builder::getResponseFilter($callback);
        }
            }
    }
...
namespace  {
            ...
            class EloquentFilter extends \eloquentFilter\Facade\EloquentFilter {}
