...
<head>
    ...
    <title>FICHA DE PERIODICA</title>
    <style>
        @page {
            margin: 40px;
        }
...
<body>
    ...
    <table
        ...
        <tr>
            <td>{{ $ficha_preocupacional['antecedentes_clinicos_quirurgicos'] }}</td>
        </tr>
    </table>
    ...
    <table
        ...
        <tr>
            ...
            <td style="width: 50%; vertical-align: top;" class="border-none">
                <table
                    style="color:#000000; table-layout:fixed; width: 100%; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px;"
                    border="1" cellpadding="0" cellspacing="0" class="celdas_amplias border-none">
                    <tr>
                    ...
                    @foreach ($ficha_preocupacional['habitos_toxicos'] as $habito)
                        <tr>
                            ...
                            <td align="center">{{ $habito['aplica'] ? 'x' : '' }}</td>
                            <td align="center">{{ !$habito['aplica'] ? 'x' : '' }}</td>
                            <td align="center">{{ $habito['tiempo_consumo_meses'] }}</td>
                            <td align="center">{{ $habito['cantidad'] }}</td>
                            <td align="center">{{ $habito['ex_consumidor'] ? 'x' : '' }}</td>
                            <td align="center">{{ $habito['tiempo_abstinencia_meses'] }}</td>
                        </tr>
                    @endforeach
                </table>
            </td>
            ...
            <td style="width: 50%; vertical-align: top;" class="border-none">
                <table
                    ...
                    <tr>
                        ...
                        <td align="center">{{ $ficha_preocupacional['actividades_fisicas'] ? (count($ficha_preocupacional['actividades_fisicas']) ? 'x' : '') : '' }}</td>
                        <td align="center">{{ $ficha_preocupacional['actividades_fisicas'] ? (!count($ficha_preocupacional['actividades_fisicas']) ? 'x' : '') : '' }}</td>
                        <td align="center">{{ $ficha_preocupacional['actividades_fisicas'] && count($ficha_preocupacional['actividades_fisicas']) ? $ficha_preocupacional['actividades_fisicas'][0]['nombre_actividad'] : '' }}</td>
                        <td align="center">{{ $ficha_preocupacional['actividades_fisicas'] && count($ficha_preocupacional['actividades_fisicas']) ? $ficha_preocupacional['actividades_fisicas'][0]['tiempo'] : '' }}</td>
                    </tr>
                    @foreach ($ficha_preocupacional['medicaciones'] as $medicacion)
                        <tr>
                            @if ($loop->index == 0)
                                <td align="center" rowspan="3">{{ 'MEDICACIÓN HABITUAL' }}</td> {{-- rowspan igual al total de elementos de medicaciones --}}
                                <td align="center" rowspan="3">{{ count($ficha_preocupacional['medicaciones']) ? 'x' : '' }}</td>
                                <td align="center" rowspan="3">{{ !count($ficha_preocupacional['medicaciones']) ? 'x' : '' }}
                                </td>
                            @endif

                            <td align="center">{{ $medicacion['nombre'] }}</td>
                            <td align="center">{{ $medicacion['cantidad'] }}</td>
                        </tr>
                    @endforeach
                </table>
            </td>
    ...
    <table
        ...
        border="1" cellpadding="0" cellspacing="0" class="celdas_amplias">
        <tr>
            <th style="width: 100%; text-align: left;">INCIDENTES</th>
        </tr>
        <tr>
            <td>
                <small class="text-mini">{{ 'Describir los principales incidentes suscitados' }}</small> <br>
                {{ '' }}
            </td>
        </tr>
    </table>
    ...
    <table
        ...
        <tr>
            <td class="fs-9">
                ...
                {{ $ficha_preocupacional['accidente_trabajo'] ? $ficha_preocupacional['accidente_trabajo']['instituto_seguridad_social'] : '____' }}
                <span class="mr-8 d-inline-block"></span>
    ...
    <table
        ...
        <tr>
            <td class="fs-9">
                ...
                <span class="mr-8 d-inline-block"></span>
                ESPECIFICAR:
                {{ $ficha_preocupacional['enfermedad_profesional'] ? $ficha_preocupacional['enfermedad_profesional']['instituto_seguridad_social'] : '____' }}
                NO @if (
                    $ficha_preocupacional['enfermedad_profesional'] &&
                        !$ficha_preocupacional['enfermedad_profesional']['calificado_iss']
                )
    ...
    <div class="titulo-seccion">D. ANTECEDENTES FAMILIARES (DETALLAR EL PARENTESCO)</div>
    ...
    {{-- F. ENFERMEDAD ACTUAL --}}
    <div class="titulo-seccion">F. ENFERMEDAD ACTUAL</div>
    <table
        style="color:#000000; table-layout:fixed; width: 100%; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px;"
        border="1" cellpadding="0" cellspacing="0" class="celdas_amplias mb-8">
        <tr>
    ...
    <div class="titulo-seccion">G. REVISIÓN DE ÓRGANOS Y SISTEMAS</div>
    <div class="border mb-8">
        <table
            style="color:#000000; table-layout:fixed; width: 100%; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px;"
            border="1" cellpadding="0" cellspacing="0" class="celdas_amplias">
    ...
    <div class="titulo-seccion">H. CONSTANTES VITALES Y ANTROPOMETRÍA</div>
    <table
        style="color:#000000; table-layout:fixed; width: 100%; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px;"
        border="1" cellpadding="0" cellspacing="0" class="celdas_amplias mb-8">
        <tr>
    ...
    <div class="titulo-seccion">I. EXAMEN FÍSICO REGIONAL</div>
    ...
    <div class="titulo-seccion">J. RESULTADOS DE EXÁMENES GENERALES Y ESPECÍFICOS DE ACUERDO AL RIESGO Y PUESTO DE
            ...
            <tr>
                ...
                <td>
                    <table
                        ...
                        border="0">
                        <tr>
                            <th style="border: none; width: 25%; background: #fff; text-align: left;">{{ 'Parámetro' }}</th>
                            <th style="border: none; width: 25%; background: #fff; text-align: left;">{{ 'Resultado' }}</th>
                            <th style="border: none; width: 50%; background: #fff; text-align: left;">{{ 'Observación' }}</th>
                        </tr>
    ...
    {{-- L. APTITUD MÉDICA LABORAL --}}
    <div class="titulo-seccion">L. APTITUD MÉDICA PARA EL TRABAJO</div>
    <div class="border mb-8">
        <table
            style="color:#000000; table-layout:fixed; width: 100%; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px;"
            border="1" cellpadding="0" cellspacing="0">
    ...
    <div class="titulo-seccion">M. RECOMENDACIONES Y/O TRATAMIENTO</div>
    <table
        style="color:#000000; table-layout:fixed; width: 100%; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px;"
        border="1" cellpadding="0" cellspacing="0" class="celdas_amplias mb-8">
        <tr>
    ...
    <span style="width: 77%; display: inline-block;" class="border mr-8">
        <div class="titulo-seccion">N. DATOS DEL PROFESIONAL DE SALUD</div>
    ...
    <span style="width: 20%; display: inline-block;" class="border">
        <div class="titulo-seccion">O. FIRMA DEL USUARIO</div>
