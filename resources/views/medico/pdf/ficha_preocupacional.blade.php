...
<table
    ...
    <tr>
        <td>{{ $ficha_preocupacional['antecedente_clinico_quirurgico'] }}</td>
    </tr>
</table>
...
<table
    ...
    <tr>
        ...
        <td>{{ 1 <= count($ficha_preocupacional['examenes_realizados']) && $ficha_preocupacional['examenes_realizados'][0]['tipo'] == 'M' ? (!$ficha_preocupacional['examenes_realizados'][0]['resultado'] ? 'x' : '') : 'x' }}
        </td>
    ...
    <tr>
        ...
        <td>{{ 2 <= count($ficha_preocupacional['examenes_realizados']) && $ficha_preocupacional['examenes_realizados'][1]['tipo'] == 'M' ? (!$ficha_preocupacional['examenes_realizados'][1]['resultado'] ? 'x' : '') : 'x' }}
        </td>
...
<div class="titulo-seccion">L. RESULTADOS DE EXÁMENES GENERALES Y ESPECÍFICOS DE ACUERDO AL RIESGO Y PUESTO DE
    TRABAJO (IMAGEN, LABORATORIO Y OTROS)
</div>
<table
    style="color:#000000; table-layout:fixed; width: 100%; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px;"
    border="1" cellpadding="0" cellspacing="0" class="celdas_amplias mb-8">
...
<table
    ...
    @if (count($ficha_preocupacional['consultas_medicas']) === 0)
        <tr>
            ...
            <td style="width: 55%;">{{ 'Examen de Salud Ocupacional' }}</td>
            <td style="width: 25%;">{{ 'Z10.0' }}</td>
            <td style="width: 8%;">{{ '' }}</td>
