    ...
    <table width="100%" border="1" cellspacing="0" bordercolor="#666666" class="gastos">
        ...
        <tr>
            ...
            <td style="font-size:10px">
                <div class="col-md-3">
                    <a href="{{ url($registro->saldoable->comprobante) }}" target="_blank" title="nombreImagen">
                        <img
                            src="{{ file_exists(public_path() . $registro->saldoable->comprobante) ? 'data:image/png;base64,' . base64_encode(file_get_contents(public_path() . $registro->saldoable->comprobante)) : ' ' }}"
                            width="250"/>
                    </a>
                </div>
            </td>
            <td style="font-size:10px">
                <div class="col-md-3">
                    @php
                        $comprobante = isset($registro->saldoable->comprobante2) ? $registro->saldoable->comprobante2 : $registro->saldoable->comprobante;
                    @endphp
                    <a href="{{ url($comprobante) }}" target="_blank" title="nombreImagen">
                        <img
                            src="{{ file_exists(public_path() . $comprobante) ? 'data:image/png;base64,' . base64_encode(file_get_contents(public_path() . $comprobante)) : ' ' }}"
                            width="250"/>
                    </a>
                </div>
            </td>
            ...
            <td style="font-size:10px">
                <div class="col-md-3" align="center">
                    <a href="{{ url($transferencia_enviada['comprobante']) }}" target="_blank" title="nombreImagen">
                        <img
                            src="{{ file_exists(public_path() . $transferencia_enviada['comprobante']) ? 'data:image/png;base64,' . base64_encode(file_get_contents(public_path() . $transferencia_enviada['comprobante'])) : ' ' }}"
            ...
            <td style="font-size:10px">
                <div align="center">
                    <a href="{{ url($transferencia_recibida_data['comprobante']) }}" target="_blank"
                       title="nombreImagen">
                        <img
                            src="{{ file_exists(public_path() . $transferencia_recibida_data['comprobante']) ? 'data:image/png;base64,' . base64_encode(file_get_contents(public_path() . $transferencia_recibida_data['comprobante'])) : ' ' }}"
                            style="max-width: 100%; height: auto;"/>
                    </a>
                </div>
            </td>
