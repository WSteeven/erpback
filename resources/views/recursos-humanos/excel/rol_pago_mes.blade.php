                                    ...
                                    <td height="55px;">
                                        <table width="100%" border="1" align="left" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr class="encabezado-datos" style="text-align: center ">
                                                ...
                                                <td rowspan="2" style="text-align: center !important;background-color: #DBDBDB;">AREA</td>
                                                <td
                                                    rowspan="2" style="  text-align: center !important;
                                                                                background-color: #DBDBDB;">
                                                    CARGO
                                            ...
                                            <tr class="encabezado-datos">
                                                ...
                                                @foreach ($columnas_egresos as $egreso)
                                                    <th scope="col" class="encabezado-egresos" style="text-align: center !important;
                                                                                        background-color: #BDD7EE;">{{ strtoupper($egreso) }}</th>
                                                @endforeach
                                            </tr>
