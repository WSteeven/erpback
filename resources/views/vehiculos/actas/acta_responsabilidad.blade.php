...
<body>
    ...
    <main>
        <div class="justificado">
            ...
            <p>La entrega de dicho vehículo se realiza por parte del señor {{ $asignacion['entrega'] }} con cédula de
                identidad número {{ $entrega['identificacion'] }} al señor {{ $asignacion['responsable'] }} con cédula
                de identidad
                número {{ $responsable['identificacion'] }}, quien asume la responsabilidad completa sobre el mismo a
            ...
            <ul>
                <li>Estado de carrocería:
                    @foreach ($asignacion['estado_carroceria'] as $estado)
                        {{ $estado }},
                    @endforeach
                </li>
                <li>Estado de mecánico:
                    @foreach ($asignacion['estado_mecanico'] as $estado)
                        {{ $estado }},
                    @endforeach
                </li>
                <li>Estado Sistema Eléctrico y A/AC:
                    @foreach ($asignacion['estado_electrico'] as $estado)
                        {{ $estado }},
                    @endforeach
                </li>
            </ul>
            ...
            <p>Con la entrega del vehículo {{ $configuracion['razon_social'] }}, declara que el mismo se encuentra en
                buen estado y condiciones de funcionamiento, sin presentar defectos ni averías visibles.</p>
            ...
            <p>Cualquier daño o avería que se produzca en el vehículo durante el período de responsabilidad de
                {{ $asignacion['responsable'] }}, que NO sea imputable al desgaste normal, será de su exclusiva
