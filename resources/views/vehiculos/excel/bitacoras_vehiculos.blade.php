...
@php
    use App\Models\Empleado;use App\Models\Tarea;use Src\Shared\Utils;
...
<table
    ...
    @foreach($reporte as $bitacora)
        <tr>
            ...
            <td>{{ $bitacora->tareas ? Tarea::whereIn('id', array_map('intval', Utils::convertirStringComasArray($bitacora->tareas)))->pluck('codigo_tarea'): null }}</td>
