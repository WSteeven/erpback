...
<head>
    ...
    <title>Prefactura N° {{ $prefactura['id'] }}</title>
    <style>
        @page {
            ...
            <tr class="row">
                ...
                <td style="width: 50%">
                    <table style="margin-left:auto; margin-right:auto; text-align:center;">
                        <tr>
                            <td align="right">
                                <b style="font-size: 24px; margin-left: 30px">PREFACTURA</b>
                            </td>
                        </tr>
                        <tr>
                            <td align="center">
                        ...
                        <tr>
                            <td align="center">
                                <b>Fecha: </b>{{ date('Y-m-d', strtotime($prefactura['created_at'])) }}
                            </td>
                        </tr>
                    </table>
                </td>
    ...
    <main>
                ...
                <td width="60%" style="min-width: 100%">
                    <table style="width: 90%" border="1">
                        ...
                        <tr>
                            ...
                            <td>{{ $prefactura['solicitante'] }}<br>{{ $empleado_solicita->user->email }}</td>
                        </tr>
                    </table>
                </td>
                <td width="40%">
                    <table border="1">
                        ...
                        <tr>
                            ...
                            <td>{{ $prefactura['tiempo'] }} a partir de la fecha de creación</td>
                        </tr>
                    </table>
                </td>
            </tr>
        ...
        <table
            ...
            <tbody>
                ...
                @foreach ($prefactura['listadoProductos'] as $index => $item)
            ...
            <tr>
                <td width="70%">
                    <table border="1" style="max-width: 100%;width: 90%">
                        ...
                        <tr>
                            <td style="height: 100px" valign="top">{{ $prefactura['descripcion'] }}</td>
                        </tr>
                    </table>
                </td>
                <td width="30%">
