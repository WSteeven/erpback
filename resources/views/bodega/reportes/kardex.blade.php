...
<head>
    <meta charset="utf-8">
    <title>Reporte de movimientos de un producto </title>
    <style>
        @page {
            ...
            <tbody style="font-size: 8px">
                @foreach ($results as $result)
                    <tr>
                        ...
                        <td>{{ $result['num_transaccion'] }}</td>
                        <td>{{ $result['motivo'] }}</td>
                        <td>{{ $result['tipo'] }}</td>
                        <td align="center">{{ $result['cant_anterior'] }}</td>
                        <td align="center">{{ $result['cantidad'] }}</td>
                        <td align="center">{{ $result['cant_actual'] }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
