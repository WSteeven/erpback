...
<footer>
    <table class="firma" style="width: 100%;">
        <thead>
        <th align="center">
            @isset($persona_responsable->firma_url)
                <img src="{{ Utils::urlToBase64(url($persona_responsable->firma_url)) }}" alt="" width="100%"
                     height="40">
            @endisset
            @empty($persona_responsable->firma_url)
        ...
        <th align="center"></th>
        <th align="center">
            @isset($persona_autoriza->firma_url)
                <img src="{{ Utils::urlToBase64(url($persona_autoriza->firma_url)) }}" alt="" width="100%" height="40">
            @endisset
            @empty($persona_responsable->firma_url)
                ___________________<br/>
            @endempty
    ...
    <table style="width: 100%;">
        <tr>
            ...
            <td>
                <div align="right"><img
                        src="data:image/svg;base64,{!! base64_encode(QrCode::format('svg')->encoding('UTF-8')->size(70)->generate($mensaje_qr)) !!}">
                </div>
            </td>
        </tr>
    </table>
